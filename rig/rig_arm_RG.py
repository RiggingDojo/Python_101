...
class Rig_Arm:
    ...
    # Class methods should use sel in these instances ---- RG
    def rig_arm(self):
        print "In Rig Arm"
...
#Building joints
# Here you use self to reference a local function   ---- RG
# These function calls don't belong to the class.  For now you can fix that by putting them in the rig_arm function
"""
self.create_arm_jnt("IK_")
self.create_arm_jnt("FK_")
self.create_arm_jnt("bn_")
